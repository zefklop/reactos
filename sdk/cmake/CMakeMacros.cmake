...
function(add_importlibs _module)
    ...
    foreach(LIB ${ARGN})
        ...
        if (GCC AND CMAKE_BUILD_TYPE STREQUAL "Debug")
            if ((LIB STREQUAL "ntoskrnl") OR (LIB STREQUAL "ntdll"))
                target_link_libraries(${_module} gcc_ubsan_nt)
            endif()
            #[[ msvcrt case is handled with msvcrtex
            if (LIB STREQUAL "msvcrt")
                target_link_libraries(${_module} gcc_ubsan_msvcrt)
            endif()
            ]]
            if (LIB STREQUAL "scsiport")
                target_link_libraries(${_module} gcc_ubsan_scsiport)
            endif()
            if (LIB STREQUAL "win32k")
                target_link_libraries(${_module} gcc_ubsan_win32k)
            endif()
            if (LIB STREQUAL "videoprt")
                target_link_libraries(${_module} gcc_ubsan_videoprt)
            endif()
        endif()
