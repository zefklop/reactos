...
@ cdecl -private -arch=x86_64,arm __C_specific_handler(ptr long ptr ptr)
@ cdecl -private -arch=x86_64 __chkstk()
@ cdecl -private __isascii(long)
@ cdecl -private __iscsym(long)
@ cdecl -private __iscsymf(long)
@ cdecl -private -arch=arm __jump_unwind()
@ cdecl -private -stub -version=0x600+ -arch=x86_64 __misaligned_access()
@ cdecl -private __toascii(long)
@ cdecl -private -arch=i386 -ret64 _alldiv(double double)
@ cdecl -private -arch=i386 _alldvrm()
@ cdecl -arch=i386 -ret64 _allmul(double double) # Not limited to CRT, used in compiler intrinsics
@ cdecl -private -arch=i386 -norelay _alloca_probe()
@ cdecl -private -version=0x600+ -arch=i386 _alloca_probe_16()
@ stub -private -version=0x600+ -arch=i386 _alloca_probe_8
@ cdecl -arch=i386 -ret64 _allrem(double double) # Not limited to CRT, used in compiler intrinsics
@ cdecl -arch=i386 _allshl() # Not limited to CRT, used in compiler intrinsics
@ cdecl -arch=i386 _allshr() # Not limited to CRT, used in compiler intrinsics
@ cdecl -private -ret64 _atoi64(str)
@ cdecl -arch=i386 -ret64 _aulldiv(double double) # Not limited to CRT, used in compiler intrinsics
@ cdecl -arch=i386 _aulldvrm() # Not limited to CRT, used in compiler intrinsics
@ cdecl -arch=i386 -ret64 _aullrem(double double) # Not limited to CRT, used in compiler intrinsics
@ cdecl -arch=i386 _aullshr() # Not limited to CRT, used in compiler intrinsics
@ cdecl -private -arch=i386 _chkstk()
@ cdecl -private -arch=i386,x86_64,arm _fltused()
...
@ cdecl -private -arch=x86_64 _local_unwind()
...
@ cdecl -private -arch=x86_64 _setjmp(ptr ptr)
@ cdecl -private -arch=x86_64 _setjmpex(ptr ptr)
@ varargs -private _snprintf(ptr long str)
@ varargs -private _snwprintf(ptr long wstr)
...
@ stub -private -version=0x600+ _swprintf
@ cdecl -private -version=0x502 _tolower(long)
@ cdecl -private -version=0x502 _toupper(long)
...
@ cdecl -private _vscwprintf(wstr ptr)
@ cdecl -private _vsnprintf(ptr long str ptr)
@ cdecl -private _vsnwprintf(ptr long wstr ptr)
@ stub -private -version=0x600+ _vswprintf
@ cdecl -private _wcsicmp(wstr wstr)
@ cdecl -private _wcslwr(wstr)
@ cdecl -private _wcsnicmp(wstr wstr long)
@ cdecl -private _wcstoui64(wstr ptr long)
@ cdecl -private _wcsupr(wstr)
@ cdecl -private _wtoi(wstr)
@ cdecl -private _wtoi64(wstr)
@ cdecl -private _wtol(wstr)
@ cdecl -private abs(long)
@ cdecl -private -arch=i386,x86_64 atan(double)
...
@ cdecl -private iswalpha(long)
@ cdecl -private iswctype(long long)
@ cdecl -private iswdigit(long)
@ cdecl -private iswlower(long)
@ cdecl -private iswspace(long)
@ cdecl -private iswxdigit(long)
@ cdecl -private isxdigit(long)
@ cdecl -private labs(long)
@ cdecl -private -arch=i386,x86_64 log(double)
@ cdecl -private -arch=x86_64 longjmp(ptr)
@ cdecl -private mbstowcs(ptr str long)
@ cdecl -private memchr(ptr long long)
@ cdecl -private memcmp(ptr ptr long)
@ cdecl -private memcpy(ptr ptr long) memmove
@ cdecl -private memmove(ptr ptr long)
@ cdecl -private memset(ptr long long)
@ cdecl -private -arch=i386,x86_64,arm pow(double double)
@ cdecl -private qsort(ptr long long ptr)
@ cdecl -private sin(double)
@ varargs -private sprintf(ptr str)
@ cdecl -private -arch=i386,x86_64 sqrt(double)
...
@ varargs -private swprintf(ptr wstr)
@ cdecl -private -arch=i386,x86_64 tan(double)
@ cdecl -private tolower(long)
@ cdecl -private toupper(long)
@ cdecl -private towlower(long)
@ cdecl -private towupper(long)
@ stdcall vDbgPrintEx(long long str ptr)
@ stdcall vDbgPrintExWithPrefix(str long long str ptr)
@ cdecl -private vsprintf(ptr str ptr)
@ cdecl -private wcscat(wstr wstr)
@ cdecl -private wcschr(wstr long)
@ cdecl -private wcscmp(wstr wstr)
@ cdecl -private wcscpy(ptr wstr)
@ cdecl -private wcscspn(wstr wstr)
@ cdecl -private wcslen(wstr)
@ cdecl -private wcsncat(wstr wstr long)
@ cdecl -private wcsncmp(wstr wstr long)
@ cdecl -private wcsncpy(ptr wstr long)
@ cdecl -private wcspbrk(wstr wstr)
@ cdecl -private wcsrchr(wstr long)
@ cdecl -private wcsspn(wstr wstr)
@ cdecl -private wcsstr(wstr wstr)
@ cdecl -private wcstol(wstr ptr long)
@ cdecl -private wcstombs(ptr ptr long)
@ cdecl -private wcstoul(wstr ptr long)

# FIXME: check if this is correct
@ stdcall -private -arch=arm __dtoi64()
@ stdcall -private -arch=arm __dtou64()
@ stdcall -private -arch=arm __i64tod()
@ stdcall -private -arch=arm __u64tod()
@ stdcall -private -arch=arm __rt_sdiv()
@ stdcall -private -arch=arm __rt_sdiv64()
@ stdcall -private -arch=arm __rt_udiv()
@ stdcall -private -arch=arm __rt_udiv64()
@ stdcall -private -arch=arm __rt_srsh()
